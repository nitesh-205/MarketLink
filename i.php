...
$username = "if0_38818976"; // Change to your MySQL username
$password = "D44xIvt4BqZhQ"; // Change to your MySQL password
$dbname = "if0_38818976_farmer";
...
<body class="bg-gradient-to-br from-green-50 to-green-200 min-h-screen">
    <nav class="bg-white shadow-lg sticky top-0 z-50 p-6 flex justify-between items-center">
        <h2 class="text-3xl font-bold text-red-500">🧑‍🌾MaRkEt<span class="text-blue-600">LinK</span></h2>
